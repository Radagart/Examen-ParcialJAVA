...
import py.edu.ucom.services.api.GenericDaoServiceWithJson;
...
public class ApiResponseResource {
    ...
    private GenericDaoServiceWithJson serviceConConstructor;

    public ApiResponseResource(GenericDaoServiceWithJson instanciaService) {
